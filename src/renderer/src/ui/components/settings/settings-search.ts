...
const SETTINGS_CATEGORY_SEARCH_KEY_PATHS: Record<SettingsCategory, readonly string[]> = {
  ...
  permissions: [
    ...
    "settings.fields.permissionRules",
    "settings.descriptions.permissionRules",
    "settings.fields.permissionRuleTool",
    "settings.fields.permissionRulePattern",
    "settings.fields.permissionRuleEffect",
    "settings.permissionRuleTools.command",
    "settings.permissionRuleTools.write",
    "settings.permissionRuleTools.mcp",
    "settings.permissionRuleEffects.allow",
    "settings.permissionRuleEffects.ask",
    "settings.permissionRuleEffects.deny",
  ...
  mcpServers: [
    ...
    "settings.fields.mcpServerCommand",
    "settings.fields.mcpServerArgs",
    "settings.fields.mcpServerCwd",
    "settings.fields.mcpServerEnv",
    "settings.fields.mcpServerReadOnlyTools",
