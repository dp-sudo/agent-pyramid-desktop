...
const SETTINGS_CATEGORY_SEARCH_KEY_PATHS: Record<SettingsCategory, readonly string[]> = {
  ...
  toolAccess: [
    ...
    "settings.toolNames.shell_command",
    "settings.toolNames.git_bash_command",
    "settings.toolNames.powershell_command",
    "settings.toolNames.wsl_command",
    "settings.toolNames.git_status",
    "settings.toolNames.git_diff",
    "settings.toolNames.git_log",
    "settings.toolNames.git_branch",
    "settings.toolNames.git_commit",
    "settings.toolNames.package_scripts",
    "settings.toolNames.package_install",
    "settings.toolNames.package_test",
    "settings.toolNames.package_build",
    "settings.toolNames.run_lint",
    "settings.toolNames.run_format",
    "settings.toolNames.run_tests",
    "settings.toolNames.run_build",
    "settings.toolNames.start_command_session",
    "settings.toolNames.read_command_session",
    "settings.toolNames.write_command_session",
    "settings.toolNames.stop_command_session",
    "settings.toolNames.detect_shell_environment",
